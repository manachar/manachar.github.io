require({
  ...
  function init() {
    ...
    sprite1 = THREE.ImageUtils.loadTexture( 'images/snowflake-01.png' );
    sprite2 = THREE.ImageUtils.loadTexture( 'images/snowflake-02.png' );
    sprite3 = THREE.ImageUtils.loadTexture( 'images/snowflake-03.png' );
    sprite4 = THREE.ImageUtils.loadTexture( 'images/snowflake-04.png' );
    sprite5 = THREE.ImageUtils.loadTexture( 'images/snowflake-05.png' );
    sprite6 = THREE.ImageUtils.loadTexture( 'images/snowflake-06.png' );
    sprite7 = THREE.ImageUtils.loadTexture( 'images/snowflake-07.png' );
    ...
    parameters = [
      ...
      [ baseColor, sprite5, 40 ],
      [ baseColor, sprite6, 40 ],
      [ baseColor, sprite7, 40 ]
    ];
